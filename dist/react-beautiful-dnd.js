(function (global, factory) {
  ...
  */
  ...
  var shared = [function required(_ref) {
    ...
    !isBoolean(props.isDropDisabled) ?  invariant(false, "isDropDisabled must be a boolean. Received: " + typeof props.isDropDisabled + " (" + props.isDropDisabled + ")")  : void 0;
    !isBoolean(props.isCombineEnabled) ?  invariant(false, "isCombineEnabled must be a boolean. Received: " + typeof props.isCombineEnabled + " (" + props.isCombineEnabled + ")")  : void 0;
    !isBoolean(props.ignoreContainerClipping) ?  invariant(false, "ignoreContainerClipping must be a boolean. Received: " + typeof props.ignoreContainerClipping + " (" + props.ignoreContainerClipping + ")")  : void 0;
  }, function ref(_ref3) {
